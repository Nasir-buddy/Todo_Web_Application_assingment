      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden transition-all duration-300 hover:shadow-md">
        ...
        <div className="p-5">
          <div className="flex justify-between items-start mb-4">
            <h3 className="text-xl font-bold text-gray-800 leading-tight pr-4">{todo.title}</h3>
            <div className={`flex items-center rounded-full ${statusStyle.bg} ${statusStyle.text} px-3 py-1 text-xs font-medium whitespace-nowrap`}>
